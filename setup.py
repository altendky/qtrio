...
setup(
    ...
    extras_require={
        ...
        "pyside2": ["pyside2"],
        "checks": ["black", "flake8"],
        "docs": ["sphinx >= 1.7.0", "sphinx_rtd_theme", "sphinxcontrib-trio", "towncrier"],
        "tests": ["coverage", "pytest", "pytest-cov", "pytest-faulthandler", "pytest-qt", 'pytest-xvfb; sys_platform == "linux"'],
    },
