...
def test_signal_emits(qtbot: pytestqt.qtbot.QtBot):
...
def test_signal_emits_value(qtbot: pytestqt.qtbot.QtBot):
...
def test_connection_connects(qtbot: pytestqt.qtbot.QtBot):
...
def test_connection_disconnects(qtbot: pytestqt.qtbot.QtBot):
...
def test_connection_yield_can_be_disconnected(qtbot: pytestqt.qtbot.QtBot):
